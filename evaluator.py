...
from ARGUS_utils.dataset import Extra_Dataset
from ARGUS_utils.metrics import plot_roc_curve, save_fpr_tpr_auc
from ARGUS_models.main_model import ARGUS
import numpy as np
import random
...
def parse_args():
    parser = argparse.ArgumentParser(description="Train MSUNI")
...
if __name__ == '__main__':
    ...
    model = ARGUS(n_classes=num_classes, freeze_ratio=args.freeze_ratio, cmb=args.cmb, ckpt_path=args.UNI_path)
    ckpt_path = r''

...
from contrast_experiment.sml_metrics import val_auc
from contrast_models.sml_UNI_model import sml_UNI
import numpy as np
import random
...
if __name__ == '__main__':
    ...
    model = sml_UNI(n_classes=num_classes, freeze_ratio=args.freeze_ratio, cmb=args.cmb, ckpt_path=args.UNI_path)
    model.to(device)
